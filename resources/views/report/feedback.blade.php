...
<head>
    <title>Cetak Kritik & Saran</title>
</head>
<style>
    table.center {
        margin-left: auto;
...
<body>
    ...
    <table class="center">
        ...
        <tr>
            <td></td>
            <td>
                <h4>Berikut adalah rekap kritik dan saran dari buku tamu.<br>Semua direkap menjadi satu disini agar
                    mudah
                    membacanya.</h4>
    ...
    <table class="center2">
        <tbody>
            <tr>
                ...
                <td>Tingkat Kepuasan Layanan</td>
                <td>Kritik</td>
                <td>Saran</td>
                <td>Waktu Berkunjung</td>
            </tr>
